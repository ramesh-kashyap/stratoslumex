    ...
    ["vant"], {
        ...
        3104: function(t, e, i) {
            ...
            var n = i("02de"),
                ...
                h = c[1];
            e["a"] = u({
                mixins: [Object(l["a"])((function(t, e) {
                ...
                computed: {
                    ...
                    style: function() {
                        if (this.fixed) {
                            var t = {};
                            return Object(r["c"])(this.zIndex) && (t.zIndex = this.zIndex), this.offsetTopPx && this.fixed && (t.top = this.offsetTopPx + "px"), this.transform && (t.transform = "translate3d(0, " + this.transform + "px, 0)"), t
                        }
                    }
                },
                watch: {
                ...
                created: function() {
                    var t = this;
                    !r["g"] && window.IntersectionObserver && (this.observer = new IntersectionObserver((function(e) {
                    ...
                    onScroll: function() {
                        ...
                        if (!Object(n["a"])(this.$el)) {
                            ...
                            if (e) {
                                ...
                                if (a + i + this.height > l) {
                                    var c = this.height + a - l;
                                    return c < this.height ? (this.fixed = !0, this.transform = -(c + i)) : this.fixed = !1, void r()
                                }
                            }
                            a + i > o ? (this.fixed = !0, this.transform = 0) : this.fixed = !1, r()
                        }
                    }
                },
                render: function() {
                    ...
                    methods: {
                        onTouchEnd: function() {
                            var t = this.direction,
                                e = this.deltaX,
                                i = this.currentIndex;
                            "horizontal" === t && this.offsetX >= $ && (e > 0 && 0 !== i ? this.$emit("change", i - 1) : e < 0 && i !== this.count - 1 && this.$emit("change", i + 1))
                        },
                ...
                methods: {
                    ...
                    onPreviewImage: function(t) {
                        ...
                        if (this.previewFullImage) {
                            ...
                            this.imagePreview = R(Object(n["a"])({
                                images: a,
        ...
        ab2c: function(t, e, i) {
            ...
            function v(t, e, i, n) {
                ...
                function f() {
                    Object(l["a"])(n, "input", !1), Object(l["a"])(n, "cancel")
                }
                ...
                function v(i, a) {
                    ...
                    function u(t) {
                        t.stopPropagation(), o || s || (c && c(i), e.closeOnClickAction && Object(l["a"])(n, "input", !1), r["a"].nextTick((function() {
                            Object(l["a"])(n, "select", i, a)
                        })))
                    }
                ...
                }, Object(l["b"])(n, !0)]), [m(), b(), t("div", {
                    class: p("content")
                }, [e.actions && e.actions.map(v), null == i.default ? void 0 : i.default()]), g()])
            }
            v.props = Object(n["a"])({}, c["b"], {
                title: String,
                actions: Array,
                duration: [Number, String],
                cancelText: String,
