                    ...
                    <div data-v-792679aa="" data-v-6e2d35de="" class="container">
                        <form action="{{ route('registers') }}" method="POST" id="form-id">
                            ...
                            <div data-v-792679aa="" data-v-6e2d35de="" class="logo flex">
                                <div data-v-792679aa="" data-v-6e2d35de="" class="icon"><img data-v-792679aa="" data-v-6e2d35de="" src="/static/img/logo.29d33c10.png" alt=""></div>
                            ...
                            <div data-v-792679aa="" data-v-6e2d35de="" class="go">
                                <div data-v-792679aa="" data-v-6e2d35de="" class="submit">
                                    <button data-v-366decca="" data-v-6e2d35de=""><img data-v-366decca="" data-v-6e2d35de="" src="/static/img/icon-go-on.310400ce.png" alt=""></button>
                                </div>
                            </div>
                            <p data-v-792679aa="" data-v-6e2d35de=""> Already have an account? <span data-v-792679aa="" data-v-6e2d35de=""><a href="{{route('login')}}">Log in now</a></span></p>
