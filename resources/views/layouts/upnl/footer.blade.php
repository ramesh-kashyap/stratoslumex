...
">
        <div data-v-2620cc76="" class="item" href="{{route('user.dashboard')}}">
            <div data-v-2620cc76="" class="" onclick="window.location.href='{{ route('user.dashboard') }}'">
                <img data-v-2620cc76=""
                    src="{{asset('')}}static/img/1.png"
                    alt=""><span data-v-2620cc76="" style="
    color: black;
">Home</span>
            </div>
        </div>

        <div data-v-2620cc76="" class="item " onclick="window.location.href='{{ route('user.asset') }}'">
            <div data-v-2620cc76="" class="">
                <img data-v-2620cc76=""
                    src="{{asset('')}}static/img/2.png"
                    alt=""><span data-v-2620cc76="" style="
    color: black;
">Assets</span>
            </div>
